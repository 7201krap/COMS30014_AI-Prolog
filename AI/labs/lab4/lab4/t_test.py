...
# This code is provided as additional "bonus" code for the first GA lab class for the AI unit (COMSM0014)
...
#         the t-test expects each set of numbers to be normally distributed with similar std deviation
def t_test(data1, data2):
    # calc mean, stdev and stderr of each sample
    ...
    # calc the standard error for the difference between the sample means
    sterrdm = math.sqrt(sterr1*sterr1 + sterr2*sterr2)

    # calculate the "t" statistic
    t = (mean1-mean2)/sterrdm

    # calc the "degrees of freedom" ("df")
...
#   If t is large we say that the difference between the samples is *significant*
#   You can use scipy or some other python package to check for significance
#     or you can give "t" and "df" (the "degrees of freedom" in your data = (n1-1)+(n2-1)) to an online calculator:
